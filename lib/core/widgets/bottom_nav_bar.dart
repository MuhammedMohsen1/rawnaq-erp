...
class AppBottomNavBar extends StatelessWidget {
  ...
  int _getSelectedIndex(
    ...
    if (isSiteEngineer) {
      ...
      if (currentPath == AppRoutes.tasks) return hasSitePricing ? 3 : 2;
      if (currentPath == AppRoutes.gantt) return hasSitePricing ? 4 : 3;
      if (currentPath == AppRoutes.settings) return hasSitePricing ? 5 : 4;
      return 0;
    }
  }
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<AuthBloc, AuthState>(
      builder: (context, authState) {
        ...
        final useDesignerMenu =
            isDesigner && !isSiteEngineer && !isAdminOrManager;
        final useSiteOnlyMenu =
            isSiteEngineer && !isDesigner && !isAdminOrManager;
        final useSpecialistComboMenu =
            isSiteEngineer && isDesigner && !isAdminOrManager;
