...
class AppColors {
  // ============================================
  // DARK THEME COLORS - Rawnaq Project Management
  // ============================================

  // Background colors (unified with sidebar)
  static const Color scaffoldBackground = Color(0xFF161B22);
  static const Color cardBackground = Color(0xFF1C2128);
  static const Color surfaceColor = Color(0xFF21262D);
  static const Color sidebarBackground = Color(0xFF161B22);
  ...
  static const Color lightGrey = Color(0xFF6E7681);
  ...
  // Table colors
  static const Color tableHeader = Color(0xFF21262D);
  static const Color tableRowEven = Color(0xFF161B22);
  static const Color tableRowOdd = Color(0xFF0D1117);
  static const Color tableRowHover = Color(0xFF1F2937);
